...
export default function TeamEdit({
    ...
    const pageTitle = permissions.canUpdateTeam
        ? t('teams.edit.page_title_edit', { name: team.name })
        : t('teams.edit.page_title_view', { name: team.name });
    ...
    const updateMemberRole = (member: TeamMember, newRole: string) => {
        router.visit(updateMember([team.slug, member.id]), {
            ...
            preserveScroll: true,
            onError: () => {
                toast.error(t('teams.member.toast_failed'));
            },
        });
    };
            ...
            <div className="flex flex-col space-y-10">
                <div className="space-y-6">
                    {permissions.canUpdateTeam ? (
                        <>
                            <Heading
                                variant="small"
                                title={t('teams.edit.team_settings_title')}
                                description={t(
                                    'teams.edit.team_settings_description',
                                )}
                            />
                ...
                <div className="space-y-6">
                    <div className="flex items-center justify-between">
                        <Heading
                            variant="small"
                            title={t('teams.edit.team_members_title')}
                            description={
                                permissions.canCreateInvitation
                                    ? t('teams.edit.team_members_description')
                                    : ''
                            }
                        />
                        ...
                        {permissions.canCreateInvitation ? (
                            ...
                            >
                                <UserPlus /> {t('teams.edit.invite_member')}
                            </Button>
                        ) : null}
                    </div>
                ...
                {invitations.length > 0 ? (
                    <div className="space-y-6">
                        <Heading
                            variant="small"
                            title={t('teams.edit.pending_invitations_title')}
                            description={t(
                                'teams.edit.pending_invitations_description',
                            )}
                        />
                ...
                {permissions.canDeleteTeam && !team.isPersonal ? (
                    <div className="space-y-6">
                        <Heading
                            variant="small"
                            title={t('teams.edit.delete_team_title')}
                            description={t(
                                'teams.edit.delete_team_description',
                            )}
                        />
                        <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                            <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
                                <p className="font-medium">
                                    {t('teams.edit.warning')}
                                </p>
                                <p className="text-sm">
                                    {t('teams.edit.delete_warning')}
                                </p>
                            </div>
                            <Button
                                variant="destructive"
