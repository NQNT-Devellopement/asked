    ...
    return (
        <>
            ...
            <div className="space-y-6">
                <Heading
                    variant="small"
                    title={t('settings.security.password_section_title')}
                    description={t(
                        'settings.security.password_section_description',
                    )}
                />
            ...
            {canManageTwoFactor && (
                <div className="space-y-6">
                    <Heading
                        variant="small"
                        title={t('settings.security.two_factor_section_title')}
                        description={t(
                            'settings.security.two_factor_section_description',
                        )}
                    />
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                {t(
                                    'settings.security.two_factor_enabled_description',
                                )}
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                {t(
                                    'settings.security.two_factor_disabled_description',
                                )}
                            </p>
