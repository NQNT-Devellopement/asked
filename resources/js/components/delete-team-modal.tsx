                    ...
                    {({ errors, processing }) => (
                        <>
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    {t('teams.delete.description_prefix')}{' '}
                                    <strong>&quot;{team.name}&quot;</strong>
                                    {t('teams.delete.description_suffix')}
                                </DialogDescription>
                            </DialogHeader>
                            ...
                            <div className="space-y-4 py-4">
                                <div className="grid gap-2">
                                    <Label htmlFor="confirmation-name">
                                        {t('teams.delete.confirm_label_prefix')}{' '}
                                        <strong>&quot;{team.name}&quot;</strong>{' '}
                                        {t('teams.delete.confirm_label_suffix')}
                                    </Label>
                                    <Input
