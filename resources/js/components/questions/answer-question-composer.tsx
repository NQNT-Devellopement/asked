...
import { answer } from '@/routes/questions';
...
export function AnswerQuestionComposer({
    questionId,
    initialUrl,
    initialLabel,
    onCancel,
    ...
    const submit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        patch(answer([teamSlug, questionId]).url, {
            preserveScroll: true,
            preserveState: true,
            onSuccess: () => {
                toast.success(t('questions.answer_composer.toast_saved'));
                reset();
                onSaved();
            },
            onError: () => {
                toast.error(t('questions.answer_composer.toast_failed'));
            },
        });
    };
